...
<img src="web/public/favicon.svg" alt="SimpleStock" width="80" />
...
|---------|-------------|-------|
| **[web](./web/)** | React SPA frontend | React 19, Vite 7, Tailwind CSS, Chart.js |
| **[server](./server/)** | Express REST API backend | Express 4, MongoDB, Mongoose 9, Winston |
...
All commands are run from the `packages/` directory.
...
|------|---------|---------|
| `server/.env` | Server | Database, auth, logging config |
| `web/.env.development` | Web | Development settings |
| `web/.env.production` | Web | Production settings |
| `web/.env.demo` | Web | Demo mode settings |
...
[Web Package](./web/) • [Server Package](./server/) • [Back to Top](#simplestock-monorepo)
